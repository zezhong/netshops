...
<html>
  ...
  <center>
    ...
    <form action="/shops/adminUpdateAlterProduct" method="post" name="form">
    <table>
    <tr><td> productId   </td><td>     <input type="text" name="productId" value=<%=request.getParameter("productId") %> />     </td></tr>
    ...
    <tr><td>    </td><td>  	<input type="submit" value="修改商品信息" />    </td></tr>
